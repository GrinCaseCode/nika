...
$(".input-phone").mask("+7 (999) 999-99-99");
	...
	//плавный скролл
	$(".links-article li a").mPageScroll2id({
		offset: 150
	});


	//кнопка sandwich
$has_child = $(".header__top li").has("ul");
	//кнопка sandwich
	$(".btn_nav").click(function() {
		$(".sandwich").toggleClass("active");
		if ($(".header__top").is(":hidden")) {
    ...
    if ($(window).width() < 768) { 
     ...
     $(".header__top li a").click(function(e) {
...
$(".title-footer").click(function() {
		...
		$(this).siblings(".content-footer").slideToggle(200);
...
$(".item-question__head").click(function() {
	...
	function heightDetect() {
		$('.header__top').css("height", $(window).height() -$(".header").height() + 60);
	};
	heightDetect();
	...
	$('.tabs-portfolio li a').click(function(event) {
		event.preventDefault();
		$(this).parent().parent().find("li").removeClass('active');
		$(this).parent().addClass('active');
		$(this).parent().parent().siblings(".tab-container-portfolio").find(".tab-pane-portfolio").removeClass("active");
...

 {
    if ($(window).width() < 992) { 
      ...
      $('.tabs-portfolio a').on( 'click', function(){ 
        var el = $(this);
